...
module.exports = {
  ...
  execute(message,args,client) {
    ...
    let helpEmbed = new MessageEmbed()
      .setTitle("Gohan Help")
      .setAuthor('Click here to invite me !', 'https://cdn.discordapp.com/attachments/885620613950099549/889479692904710214/unknown.png', 'https://discord.com/api/oauth2/authorize?client_id=887800930244894762&permissions=49572160&scope=bot')
      .setDescription(`**PREFIX:** \`${PREFIX}\``)
      .setFooter( client.user.username +`Type: ${PREFIX}help <Command>  for more information!`, "https://cdn.discordapp.com/attachments/885620613950099549/889479692904710214/unknown.png")
      .setColor("#F0EAD6");
